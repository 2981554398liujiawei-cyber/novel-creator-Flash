...
MANAGED_FILES = (
    ...
    "state/current.json",
    "state/reader-model.json",
    "state/writing-settings.json",
    "canon/prose-contract.md",
...
READER_ENDING_PULLS = {"strong", "fair", "weak", "restful"}
    ...
    if entity_id.startswith("CHAR-"):
        ...
        if not isinstance(voice, (str, dict)):
            ...
            text_fields = (
                ...
                "inner_monologue_distance", "default_misinterpretation", "silence_pattern",
            )
            list_fields = (
